...
def params():
	...
	parser = argparse.ArgumentParser('Deobfuscate scripts by replacing all function calls with their values.#c3No')
	parser.add_argument('--funcName',  '-n', type=str, help="Name of the deobfusshation function" )
	...
	parser.add_argument('--concatChars', '-c', type=str, default="", help='set of concatenation ssh chars between two function calls\n X(83)&X(83)+X(72) then -c "^&" Note:^ is used as escape char in windows cmdline' )
